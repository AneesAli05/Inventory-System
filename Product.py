...
def show_all_products():
    fetch_products()
def product_form(window, content_frame, draw_dashboard):
    ...
    product_frame = Frame(content_frame, bg='white')
    ...
    # Back Button
    back_btn = Button(product_frame, text="⬅", font=('times new roman', 15, 'bold'), command=lambda: draw_dashboard(content_frame))
